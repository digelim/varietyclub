<?php
/**
 * mouche WooCommerce Adjacent Products Class
 *
 * @package  mouche
 * @since    2.4.3
 */
...
if ( ! class_exists( 'mouche_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The mouche WooCommerce Adjacent Products Class
	 */
	class mouche_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'mouche_woocommerce_adjacent_query_args', $args ) );
