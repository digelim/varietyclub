  ...
  if ( $the_query->have_posts() ) {
    while ( $the_query->have_posts() ) {
        ...
        $ornaments .=  '<div class="flipper-container"><div class="relative ornament-image-wrapper" style="' . $vertical_position . '; width: 14.5vw; margin-top: -20px">' .
          ...
          '  </a>' .
          '  <a href="https://twitter.com/intent/tweet?text=I\'m showing my heart during Variety BC\'s Tree of Hearts campaign ' . home_url() .'?id='. get_the_ID() .'" target="_blank" class="m-r-10 subtitle">'.
          ...
          '  </a>' .
          '  <a href="https://www.linkedin.com/shareArticle?mini=true&url=' . home_url() . '?id=' . get_the_ID()  . '&summary=I\'m%20showing%20my%20heart%20during%20Variety%20BC\'s%20Tree%20of%20Hearts%20campaign&title=A+Special+Ornament&summary=&source=" target="_blank" class="subtitle">' .
