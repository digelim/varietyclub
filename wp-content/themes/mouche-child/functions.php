...
function custom_search() {
  ...
  if ( $the_query->have_posts() ) {
    while ( $the_query->have_posts() ) {
        ...
        $show_image = ( ( ( ( $paged - 1 ) * 4 )+ $j ) % 13 );

        $index = (( ( ( ( $paged - 1 ) * 4 )+ $j ) / 13 ) % 8);
        ...
        if ( $show_image === 0 ) {
          ...
          $ornaments .=  '<div class="flipper-container"><div class="relative ornament-image-wrapper" style="' . $vertical_position . '; width: 14.5vw; margin-top: -20px">' .
            '<svg class="full-width block ornament-image front" height="232.493" viewBox="0 0 212.813 250.493" width="208.813" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' .
