  ...
  if ( $the_query->have_posts() ) {
    while ( $the_query->have_posts() ) {
        ...
        $ornaments .=  '<div class="flipper-container"><div class="relative ornament-image-wrapper" style="' . $vertical_position . '; width: 14.5vw; margin-top: -20px">' .
          ...
          '  <foreignObject width="12vw" height="13vw" y="6vw" x="1.25vw">'.
        ...
        if ( $show_new_brench ) {
          ...
          $output .= '<div class="col-md-6 m-b-50">' .
            '<img class="block full-width" style="transform: ' . $rotate . '" src="' . get_bloginfo('stylesheet_directory') . '/images/branches-'. $branch . '-desktop.png" alt="Image">' .
