...
<section id="header">
  <img class="block" src="<?php echo bloginfo('stylesheet_directory'); ?>/images/header.png" alt="Image">
</section>

<section>
  <div class="container width-1150 align-center p-t-70 p-b-130">
    ...
    <div class="input-icon-right width-350 margin-auto">
      <input class="full-width" type="text" name="search" placeholder="Search Ornaments">
